    ...
    $(function () {
        ...
        $('#node_delete').click(function (e) {
         ...
         $('#node_options').click(function (e) {
            ...
            window.location = '/admin/category-job/edit/' + sel
        });
         ...
         $('#node_view').click(function (e) {
            ...
            window.location = '/jobs?VacancySearch[job_list]=' + sel
        });
        ...
        function init_jstree(el, data, refresh) {
            ...
            el_tree.on('delete_node.jstree', function (e, obj) {
                processChangesInTree('/admin/category-job/delete', {node: obj.node}, 'Не удалось удалить категорию.\nПроверьте соединение с интернетом и повторите попытку.');
            })

            // handle node renaming
            el_tree.on('rename_node.jstree', function (e, obj) {
                processChangesInTree('/admin/category-job/update', {node: obj.node}, 'Не удалось переименовать категорию.\nПроверьте соединение с интернетом и повторите попытку.');
            });

            // handle node cration
            el_tree.on('create_node.jstree', function (e, obj) {
                processChangesInTree('/admin/category-job/create', {node: obj.node}, 'Не удалось добавить категорию.\nПроверьте соединение с интернетом и повторите попытку.');
            });
            ...
            el_tree.on('move_node.jstree', function (e, obj) {
                ...
                processChangesInTree('/admin/category-job/move', {node: node}, 'Не удалось переместить категорию.\nПроверьте соединение с интернетом и повторите попытку');
            });
