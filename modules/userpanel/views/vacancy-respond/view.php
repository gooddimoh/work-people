        ...
        <div class="registration__inner">
            <div class="registration__form">
                ...
                <div class="registration__success-desc">
                    <?= Yii::t('vacancy', 'You have applied for a job') ?> "<a href="<?= Url::to(['/vacancy/view', 'id' => $model->vacancy->id]) ?>" target="_blank"><?= $model->vacancy->categoryJob->name ?></a>".
                </div>
                <div class="registration__success-desc2">
                    <?= Yii::t('vacancy', 'Expect employer response') ?>, <br>
