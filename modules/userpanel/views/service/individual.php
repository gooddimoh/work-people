...
$this->title = Yii::t('service', 'Individual recruitment');
...
?>
<div class="individual-naim">
	<div class="container">
		<h1 class="title-sec">
			<?= Html::encode($this->title) ?>
		</h1>
		<div class="row individual-naim__row1">
			<div class="col">
				<div class="individual-naim__result">
					<h2>Оплата за результат</h2>
					<ol>
						<li>Мы подбираем кандидата</li>
						<li>Мы его проверяем</li>
						<li>Вы подтвержаете и нанимаете его</li>
						<li>Проводите оплату</li>
					</ol>
				</div>
			</div>
			<div class="col">
				...
				<p>
					48 вопросов для анкеты (в том числе, рекомандации с прошлого места работы)
				</p>
				<h3>
					Как мы ищем работника (без доплат)
				</h3>
				<ol>
					<li>Vip объявления</li>
					<li>ТОП публикация</li>
					<li>Доступ к анкетам</li>
					<li>Индивидуальный набор</li>
				</ol>
			</div>
		</div>
		<p style="max-width: 620px;">
			Ваш ассистент предоставит разные варианты анкет кандидатов на вашу позицию.
			Вам необходимо просто выбрать «лучших» из отобранных анкет.
			Стоимость рассчитывается индивидуально.
		</p>
		<p style="margin: 30px 0;">
			<b>Цены на низкоквалифицированный персонал</b> (фабрики, склады, сельское хозяйство):
		</p>
		<div class="row">
			<div class="col">
				Граждан с паспортами Украины в:
				<ul>
					<li>Польша: <b>500 грн / 1 работник</b></li>
					<li>Чехия: <b>1500 грн / 1 работник</b></li>
				</ul>
			</div>
			<div class="col">
				Граждан с паспортами <b>Европы</b> в:
				<ul>
					<li>Чехия, Германия: <b>1500 грн / 1 работник</b></li>
				</ul>
			</div>
		</div>
		<div class="individual-naim__count">
			<div class="row">
				<div class="col">
					<div class="individual-naim__count-title">
						Количество просмотров вакансии
					</div>
					Изменения в зависимости от типа публикации
				</div>
				<div class="col">
					<div class="individual-naim__grafic">
						<div class="individual-naim__grafic-wrapper">
							<div class="individual-naim__grafic-col">
								<div style="background: #fed700; height: 40px;"></div>
							</div>
							<div class="individual-naim__grafic-col">
								<div style="background: #34b9fe; height: 90px;">больше <br> в 5-7 раз</div>
							</div>
							<div class="individual-naim__grafic-col">
								<div style="background: #ff3d3e; height: 170px;">больше <br> в 10-12 раз</div>
							</div>
						</div>
						<div class="individual-naim__grafic-wrapper">
							<div class="individual-naim__grafic-col">
		...
		<div class="title-sec">
			Преимущества любой публикации
		</div>
		<div class="individual-naim__preim row">
			<div class="col individual-naim__preim-item">
				<div class="individual-naim__preim-img">
					<img src="/img/individual-naim/preim1.png" alt="">
				</div>
				<div class="individual-naim__preim-title">
					Период размещения
				</div>
				<div class="individual-naim__preim-desc">
					Вакансия размещается на 1 месяц
				</div>
			</div>
			<div class="col individual-naim__preim-item">
				<div class="individual-naim__preim-img">
					<img src="/img/individual-naim/preim2.png" alt="">
				</div>
				<div class="individual-naim__preim-title">
					Бесплатная рассылка
				</div>
				<div class="individual-naim__preim-desc">
					Помимо размещения на сайте, вакансии рассылаются по эл. почте, если они подходят под условия поиска соискателей
				</div>
			</div>
			<div class="col individual-naim__preim-item">
				<div class="individual-naim__preim-img">
					<img src="/img/individual-naim/preim3.png" alt="">
				</div>
				<div class="individual-naim__preim-title">
					Отклики соискателей
				</div>
				<div class="individual-naim__preim-desc">
					Соискатели, которых заинтересует ваша вакансия, будут присылать вам свои анкеты. Получить их вы сможете по эл. почте, а также в личном разделе «Отклики»
				</div>
			</div>
		</div>
	</div>
	<div class="profile-manager">
		<div class="container">
			...
			<div class="profile-manager__payment">
				<img src="/img/icons-svg/visa.svg" alt="">
				<img src="/img/icons-svg/mastercard.svg" alt="">
			</div>
			<div class="profile-manager__desc">
				У вас есть личный менеджер и он с радостью вам поможет по всем вопросам "WWS.work". 
				Просто выберите удобный мессенджер и напишите.
			</div>
			<div class="social">
				...
				<a href="#" class="social__viber social__link">
					<svg version="1.1" class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
					<circle class="st0" cx="256" cy="256" r="256"></circle>
	...
	<div class="profile-soiscatel">
		<div class="container">
			<a href="#" class="btn btn--dark-trans">
				Соискателю
