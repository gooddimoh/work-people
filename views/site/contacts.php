	...
	<div class="container">
		<div class="row">
				...
				<div class="contacts__item">
					...
					<div class="contacts__content">
						...
						<div class="contacts__desc">
							Если вам нужна помощь или консультация по работе сервиса, напишите нам письмо на <a href="mailto:support@wws.job" class="link">support@wws.job</a>
						</div>
					</div>
				</div>
				<div class="contacts__item">
					<div class="contacts__img">
						<img src="/img/contacts/chat.png" alt="">
					</div>
					<div class="contacts__content">
						<div class="contacts__title">
							Онлайн чат
						...
						<div class="contacts__desc">
							Для живого общение с службой поддержки, вы можете воспользоваться онлайн чатом.
			...
			<div class="col">
				<div class="contacts__item">
					<div class="contacts__img">
						<img src="/img/contacts/marker.png" alt="">
					</div>
					<div class="contacts__content">
						<div class="contacts__title">
						...
						<div class="contacts__bl">
							<div class="contacts__sub-title">
								Служба поддержки - почта:
							</div>
							<ul class="contacts__list">
								<li><b>Пн-Пт</b> - с 8 до 20:00</li>
								<li><b>Сб-Вс</b> - с 9 до 18:00</li>
							</ul>
						</div>
						<div class="contacts__bl">
							<div class="contacts__sub-title">
								Онлайн-чат - служба поддержки:
							</div>
							<ul class="contacts__list">
								<li><b>Пн-Пт</b> - с 9 до 19:00</li>
							</ul>
						</div>
						<div class="contacts__bl">
							<div class="contacts__sub-title">
								Пресс-Центр Ольга Дмитриева:
							</div>
							<ul class="contacts__list">
								<li><a href="mailto:press@wws.job" class="link">press@wws.job</a></li>
							</ul>
						</div>
						<div class="contacts__bl">
							<div class="contacts__sub-title">
							...
							<ul class="contacts__list">
								<li>Страна, Город, Улица, Дом, Офис</li>
							</ul>
						</div>
					</div>
				</div>
