...
<?php if(!Yii::$app->user->isGuest) { ?>
	<div class="search-work search-work--login">
		<div class="container">
			<div class="row">
				<div class="search-work__col-main col">
					<div class="search-work__title">
						Sign up for new jobs
					</div>
					<div class="search-work__row row">
						<div class="search-work__text col">
							Get a selection of free jobs right in the messenger
						</div>
						<div class="search-work__col col">
							<div class="social">
...
<?php } else { ?>
	<div class="search-work">
		<div class="container">
			<div class="row search-work__row-main">
				<div class="search-work__col-main col">
					<div class="search-work__title">
						Are you looking for a good job?
					</div>
					<div class="search-work__row">
						<div class="search-work__text">
							80% of employers are looking for employees directly on the basis of your resume
						</div>
						<div class="search-work__col">
							<a href="<?= Url::to(['/userpanel/resume/create']) ?>" class="search-work__btn">
								Post resume
							</a>
							<div class="search-work__desc">
								Registration time is less than 1 minute.
							</div>
						</div>
					</div>
				</div>
