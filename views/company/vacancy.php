...
<div class="container">
	<div class="row cat-nav-main">
		<div class="cat-nav-main__col">
			<div class="currency">
				<ul>
					<li><?= Yii::t('company', 'Currency') ?>:</li>
					<li>
						<!-- need drop down filter -->
						<select name="salary_currency" id="" class="j-select select" value="<?= Yii::$app->params['defaultCurrencyCharCode'] ?>">
		...
		<div class="col-cat-sidebar j-height-sticky-column">
			<div class="subscribe j-sticky">
				<div class="subscribe__title">
					<?= Yii::t('company', 'Subscribe for free hot vacancies') ?>
				</div>
				<div class="social">
